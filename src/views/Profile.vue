...
<!--         <div class="wrapper"> -->
    ...
    <div class="page-header-image" data-parallax="true" style="background-image: linear-gradient( rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.2) ), url('/assets/img/bg5.jpg'); z-index: 1">
    </div>

    <div class="content-center">
        <div class="photo-container">
            <img src="/assets/img/jessica.jpg" alt="" width="100">
